...
TRAIN_DATA_ROOT=../../yyp/CKID/
VAL_DATA_ROOT=../../yyp/CKID/
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    $TRAIN_DATA_ROOT \
    $DATA/id_label48_train.txt \
    $EXAMPLE/ckid_train_lmdb
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --shuffle \
    $VAL_DATA_ROOT \
    $DATA/id_label48_val.txt \
    $EXAMPLE/ckid_val_lmdb
